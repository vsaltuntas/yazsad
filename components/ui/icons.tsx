...
const fill = (children: React.ReactNode) =>
  function Fill({ size = 18, className }: IconProps) {
    return (
      <svg
        width={size}
        height={size}
...
export const IHome = stroke(<path d="M3 10.5L12 3l9 7.5V20a1 1 0 01-1 1h-5v-7h-6v7H4a1 1 0 01-1-1V10.5z" />);
...
export const IPlay = fill(<path d="M8 5v14l11-7z" />);
export const IPause = fill(
  <>
    <rect x="6" y="4" width="4" height="16" />
    <rect x="14" y="4" width="4" height="16" />
  </>,
);
export const ISkipF = fill(
  <>
    <path d="M5 4l10 8-10 8z" />
    <rect x="16" y="4" width="3" height="16" />
  </>,
);
export const ISkipB = fill(
  <>
